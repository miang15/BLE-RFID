...
import {onCreateAsset} from '../../redux/actions/assetActions';

const AddAssets = ({navigation}) => {
    ...
    <View style={styles.container}>
      ...
      <Formik
        ...
        initialValues={{
          ...
          salvage_value: '',
          date_acquired: '',
          dateAcquiredPicker: false,
          modal1: false,
          modal2: false,
          modal3: false,
        }}
        onSubmit={(values, {resetForm}) => {
          handleAddAssets(values), resetForm();
        }}
        ...
        {({
          ...
          <KeyboardAwareScrollView>
            <ScrollView showsVerticalScrollIndicator={false}>
              ...
              <CustomInput
                onPress={() => {
                  setFieldValue('lastScannedDatePicker', true);
                }}
              ...
              />
              <DateTimePickerModal
                isVisible={values.lastScannedDatePicker}
                mode="date"
                onConfirm={date => {
                  setFieldValue('lastScannedDatePicker', false);
              ...
              <CustomInput
                onPress={() => {
                  setFieldValue('dueDatePicker', true);
                }}
                label={'Due Date'}
                top={Theme.hp('3%')}
                horizontal={Theme.wp('4%')}
              ...
              />
              <DateTimePickerModal
                isVisible={values.dueDatePicker}
                mode="date"
                onConfirm={date => {
                  setFieldValue('dueDatePicker', false);
                  const val = moment(date).format('DD-MM-YYYY');
              ...
              <CustomInput
                onPress={() => {
                  setFieldValue('locationListModal', true);
                }}
                label={'Location'}
                top={Theme.hp('3%')}
                horizontal={Theme.wp('4%')}
              ...
              <ListModal
                renderItem={({item}) => (
                  <OptionsList
                    ...
                    onPress={() => {
                      setFieldValue('locationListModal', false);
                ...
                isVisible={values.locationListModal}
                title="Locations"
              ...
              {values.depreciation === 'Yes' ? (
                <View style={{marginBottom: Theme.hp('12%')}}>
                  ...
                  <CustomInput
                    onPress={() => {
                      setFieldValue('dateAcquiredPicker', true);
                    }}
                    label={'Date Acquired*'}
                    top={Theme.hp('3%')}
                    horizontal={Theme.wp('4%')}
                  ...
                  />
                  <DateTimePickerModal
                    isVisible={values.dateAcquiredPicker}
                    mode="date"
                    onConfirm={date => {
                      setFieldValue('dateAcquiredPicker', false);
                      const val = moment(date).format('DD-MM-YYYY');
